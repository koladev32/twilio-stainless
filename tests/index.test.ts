...
import { APIUserAbortError } from 'discord-api';
import { Headers } from 'discord-api/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['DISCORD_API_BASE_URL'] = undefined;
    });
    ...
    test('in request options overridden by env variable', () => {
      process.env['DISCORD_API_BASE_URL'] = 'http://localhost:5000/env';
      const client = new DiscordAPI({
        botToken: 'My Bot Token',
        clientId: 'My Client ID',
        clientSecret: 'My Client Secret',
