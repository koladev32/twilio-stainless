...
describe('resource activityInstances', () => {
  test('retrieve', async () => {
    const responsePromise = client.applications.activityInstances.retrieve('891', 'instance_id');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.applications.activityInstances.retrieve('891', 'instance_id', { path: '/_stainless_unknown_path' }))
      .rejects
