...
describe('resource permissions', () => {
  test('listPermissions', async () => {
    const responsePromise = client.applications.commands.permissions.listPermissions('891', '891');
  ...
  test('retrievePermissions', async () => {
    const responsePromise = client.applications.commands.permissions.retrievePermissions('891', '891', '891');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
