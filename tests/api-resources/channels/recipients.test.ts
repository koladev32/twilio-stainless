...
describe('resource recipients', () => {
  test('update', async () => {
    const responsePromise = client.channels.recipients.update('891', '891', {});
  ...
  test('delete', async () => {
    const responsePromise = client.channels.recipients.delete('891', '891');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.channels.recipients.delete('891', '891', { path: '/_stainless_unknown_path' }))
      .rejects
