...
describe('resource messages', () => {
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.webhooks.messages.retrieve('891', 'webhook_token', '891', { path: '/_stainless_unknown_path' }),
  ...
  test('delete: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.webhooks.messages.delete('891', 'webhook_token', '891', { path: '/_stainless_unknown_path' }),
    ).rejects.toThrow(DiscordAPI.NotFoundError);
  });
  ...
  test('deleteOriginal: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.webhooks.messages.deleteOriginal('891', 'webhook_token', { path: '/_stainless_unknown_path' }),
    ).rejects.toThrow(DiscordAPI.NotFoundError);
  });
  ...
  test('deleteOriginal: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.webhooks.messages.deleteOriginal(
        '891',
        'webhook_token',
        { thread_id: '891' },
        { path: '/_stainless_unknown_path' },
  ...
  test('retrieveOriginal: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.webhooks.messages.retrieveOriginal('891', 'webhook_token', { path: '/_stainless_unknown_path' }),
    ).rejects.toThrow(DiscordAPI.NotFoundError);
  });
  ...
  test('retrieveOriginal: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.webhooks.messages.retrieveOriginal(
        '891',
        'webhook_token',
        { thread_id: '891' },
        { path: '/_stainless_unknown_path' },
