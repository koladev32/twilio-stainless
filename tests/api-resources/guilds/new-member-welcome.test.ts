...
describe('resource newMemberWelcome', () => {
  test('retrieve', async () => {
    const responsePromise = client.guilds.newMemberWelcome.retrieve('891');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.guilds.newMemberWelcome.retrieve('891', { path: '/_stainless_unknown_path' }))
      .rejects
