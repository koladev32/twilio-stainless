...
describe('resource vanityURLs', () => {
  test('retrieve', async () => {
    const responsePromise = client.guilds.vanityURLs.retrieve('891');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.guilds.vanityURLs.retrieve('891', { path: '/_stainless_unknown_path' }))
      .rejects
