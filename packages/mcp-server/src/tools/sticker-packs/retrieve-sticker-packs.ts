...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/sticker-packs/{pack_id}',
  operationId: 'get_sticker_pack',
};

export const tool: Tool = {
  name: 'retrieve_sticker_packs',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  const { pack_id, jq_filter, ...body } = args as any;
  return asTextContentResult(await maybeFilter(jq_filter, await client.stickerPacks.retrieve(pack_id)));
};
