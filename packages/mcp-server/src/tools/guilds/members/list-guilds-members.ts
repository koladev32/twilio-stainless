...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/guilds/{guild_id}/members',
  operationId: 'list_guild_members',
};

export const tool: Tool = {
  name: 'list_guilds_members',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.guilds.members.list(guild_id, body)));
};
