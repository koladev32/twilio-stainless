...
export const tool: Tool = {
  name: 'retrieve_guilds_voice_states',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  const { guild_id, user_id, jq_filter, ...body } = args as any;
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.guilds.voiceStates.retrieve(guild_id, user_id)),
  );
};
