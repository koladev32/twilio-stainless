...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/guilds/{guild_id}/stickers',
  operationId: 'create_guild_sticker',
};

export const tool: Tool = {
  name: 'create_guilds_stickers',
  description:
  ...
  inputSchema: {
    ...
    required: ['guild_id', 'file', 'name', 'tags'],
  },
  annotations: {},
};
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.guilds.stickers.create(guild_id, body)),
  );
};
