...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/guilds/{guild_id}/soundboard-sounds',
  operationId: 'create_guild_soundboard_sound',
};

export const tool: Tool = {
  name: 'create_guilds_soundboard_sounds',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.guilds.soundboardSounds.create(guild_id, body)),
  );
};
