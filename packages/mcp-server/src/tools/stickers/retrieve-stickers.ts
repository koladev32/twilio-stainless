...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/stickers/{sticker_id}',
  operationId: 'get_sticker',
};

export const tool: Tool = {
  name: 'retrieve_stickers',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  const { sticker_id, jq_filter, ...body } = args as any;
  return asTextContentResult(await maybeFilter(jq_filter, await client.stickers.retrieve(sticker_id)));
};
