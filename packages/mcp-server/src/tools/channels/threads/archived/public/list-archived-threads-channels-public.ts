...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/channels/{channel_id}/threads/archived/public',
  operationId: 'list_public_archived_threads',
};

export const tool: Tool = {
  name: 'list_archived_threads_channels_public',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.channels.threads.archived.public.list(channel_id, body)),
  );
};
