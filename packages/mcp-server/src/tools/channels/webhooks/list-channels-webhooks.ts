...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/channels/{channel_id}/webhooks',
  operationId: 'list_channel_webhooks',
};

export const tool: Tool = {
  name: 'list_channels_webhooks',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.channels.webhooks.list(channel_id)));
};
