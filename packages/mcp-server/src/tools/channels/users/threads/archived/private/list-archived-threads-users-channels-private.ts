...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/channels/{channel_id}/users/@me/threads/archived/private',
  operationId: 'list_my_private_archived_threads',
};

export const tool: Tool = {
  name: 'list_archived_threads_users_channels_private',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.channels.users.threads.archived.private.list(channel_id, body)),
  );
};
