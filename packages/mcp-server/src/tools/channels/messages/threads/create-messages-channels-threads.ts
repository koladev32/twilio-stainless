...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/channels/{channel_id}/messages/{message_id}/threads',
  operationId: 'create_thread_from_message',
};

export const tool: Tool = {
  name: 'create_messages_channels_threads',
  description:
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  const { channel_id, message_id, jq_filter, ...body } = args as any;
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.channels.messages.threads.create(channel_id, message_id, body)),
  );
};
