...
export const tool: Tool = {
  name: 'put_guilds_applications_commands',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
    ...
    required: ['application_id', 'guild_id', 'body'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: DiscordAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.applications.guilds.commands.put(application_id, guild_id, body['body']),
  );
};
