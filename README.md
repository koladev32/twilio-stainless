# Discord API Node API Library

[![NPM version](https://img.shields.io/npm/v/discord-api.svg)](https://npmjs.org/package/discord-api) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/discord-api)

This library provides convenient access to the Discord API REST API from server-side TypeScript or JavaScript.
...
const response = await client.users.retrieveMe().asResponse();
console.log(response.headers.get('X-My-Header'));
console.log(response.statusText); // access the underlying Response object

const { data: userPiiResponse, response: raw } = await client.users.retrieveMe().withResponse();
...
add the following import before your first import `from "DiscordAPI"`:
