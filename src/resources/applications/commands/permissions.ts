...
export class Permissions extends APIResource {
  ...
  ): Core.APIPromise<PermissionListPermissionsResponse> {
  ...
  retrievePermissions(
    ...
    commandId: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<CommandsAPI.CommandPermissionsResponse> {
...
export declare namespace Permissions {
  export { type PermissionListPermissionsResponse as PermissionListPermissionsResponse };
}
