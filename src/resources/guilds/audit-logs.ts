...
export class AuditLogs extends APIResource {
  retrieve(guildId: string, query?: AuditLogRetrieveParams, options?: Core.RequestOptions): Core.APIPromise<GuildsAPI.GuildAuditLog>
  retrieve(guildId: string, options?: Core.RequestOptions): Core.APIPromise<GuildsAPI.GuildAuditLog>
  retrieve(guildId: string, query: AuditLogRetrieveParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<GuildsAPI.GuildAuditLog> {
