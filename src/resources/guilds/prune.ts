...
export class Prune extends APIResource {
  retrieve(
    guildId: string,
    query?: PruneRetrieveParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<GuildPrune>;
  retrieve(guildId: string, options?: Core.RequestOptions): Core.APIPromise<GuildPrune>;
  retrieve(
    guildId: string,
    query: PruneRetrieveParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<GuildPrune> {
...
export declare namespace Prune {
  export { type GuildPrune as GuildPrune, type PruneRetrieveParams as PruneRetrieveParams };
}
